...
char genfiles [][100] = 
		{
			//{"/etc/nat/cfgold/cfg.myslowice.ak"},
		//	{"/etc/nat/cfgold/cfg.myslowice.szopena-reymonta"},
		//	{"/etc/nat/cfg.lokal"},
		//	{"/etc/nat/cfg.servers"},
			...
			//{"/etc/nat/cfg.myslowice.piasek.stawowa-27"},
    			...
    			{"/etc/nat/cfg.myslowice.wezly.dystrybucja"},
                        {"/etc/nat/cfg.myslowice.wezly.dostep"},
                        {"/etc/nat/cfg.myslowice.wezly.rdzen"},                                
                        ...
                        {"/etc/nat/cfg.myslowice.publ.29.mt"},
                        {"/etc/nat/cfg.myslowice.publ.30.mt"},
                			
			{"/etc/nat/cfg.myslowice.publ.29"},
			{"/etc/nat/cfg.myslowice.publ.30"},
