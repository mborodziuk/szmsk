...
char dbcon[100] = "host=localhost port=5432 dbname=smsk user=szmsk password=szmsk";

int main()
{
    PGconn     *conn;
    conn = PQconnectdb("host=localhost port=5432 dbname=szmsk user=szmsk password=szmsk");
