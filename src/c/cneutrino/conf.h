...
#define DNS1				"172.16.32.254"
#define DNS2 				"172.16.0.1"
#define DNS3 				"91.206.65.73"

#define DOMAIN1				"netico.pl"

#define IP_LAN  			"10.0.0.0/8"
#define IP_LAN0				"172.16.32.254"
...
#define NAT1				"/etc/nat/sh/tmp/nat-lan-01.sh"
#define NAT2				"/etc/nat/sh/tmp/nat-lan-02.sh"
#define NAT3				"/etc/nat/sh/tmp/nat-lan-03.sh"
#define NAT4				"/etc/nat/sh/tmp/nat-lan-04.sh"
#define NAT5				"/etc/nat/sh/tmp/nat-lan-05.sh"
#define NAT6				"/etc/nat/sh/tmp/nat-lan-06.sh"
#define NAT7				"/etc/nat/sh/tmp/nat-lan-07.sh"
#define NAT8				"/etc/nat/sh/tmp/nat-lan-08.sh"
#define NAT16				"/etc/nat/sh/tmp/nat-lan-16.sh"
#define NAT24				"/etc/nat/sh/tmp/nat-lan-24.sh"
#define NAT32				"/etc/nat/sh/tmp/nat-lan-32.sh"
...
#define BAJT_WLAN1			32
#define BAJT_WLAN2			40
#define BAJT_WLAN3			48
#define BAJT_WLAN4			56
#define PIOCHNET_BAJT			22

#define D_LEASE_TIME 			86400
#define MAX_LEASE_TIME 			432000
