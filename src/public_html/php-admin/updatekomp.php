 <?php
  ...
  $mac=array();
   ...
   $Q1="select a.symbol, a.nazwa, a.id_abon, k.nazwa_smb, k.system, t.symbol,
			kf.dhcp, kf.powiaz_ipmac, kf.inet, kf.proxy, kf.antyporn, kf.przekier_gg, kf.przekier_ftp, kf.przekier_emule, kf.przekier_inne, k.podlaczony
	...
	'system'	=>$row1[4],				't_symbol'	=>$row1[5],		'dhcp'		=>$row1[6],			'powiaz_ipmac'	=>$row1[7],
	'inet'		=>$row1[8],			'proxy'		=>$row1[9],		'antyporn'	=>$row1[10],			'przekier_gg'	=>$row1[11],		
	'przekier_ftp'=>$row1[12],		'przekier_emule'=>$row1[13],		'przekier_inne'=>$row1[14], 'podlaczony' => $row1[15]	);
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
			...
			<?php
			 	echo "<option>".Choose ($row1[0], $row1[1])." $row1[2]</option>";
				SelectWlasc();
			?>
        </select> 
		</td>
    ...
    <tr>
	 ...
	 <tr>
		 ...
		 <td>
			<?php
				echo TableToCheckbox($komp[powiaz_ipmac], "ipmac");
			?>
	 </td>
	 </tr>
	 <tr>
		 ...
		 <td>
			<?php
				echo TableToCheckbox($komp[inet], "inet");
			?>
		 </td>
	 </tr>
	 <tr>
	 ...
	 <tr>
		 ...
		 <td>
			<?php
				echo TableToCheckbox($komp[antyporn], "antyporn");
			?>
		 </td>
	 </tr>
	 <tr>
		 ...
		 <td>
			<?php
				echo TableToCheckbox($komp[przekier_gg], "przekier_gg");
			?>
		 </td>
	 </tr>
	 <tr>
		 ...
		 <td>
			<?php
				echo TableToCheckbox($komp[przekier_ftp], "przekier_ftp");
			?>
		 </td>
	 </tr>
	 <tr>
		 ...
		 <td>
			<?php
				echo TableToCheckbox($komp[przekier_emule], "przekier_emule");
			?>
		 </td>
	 </tr>
	 <tr>
		 ...
		 <td>
			<?php
				echo TableToCheckbox($komp[przekier_inne], "przekier_inne");
			?>
		 </td>
	 </tr>
