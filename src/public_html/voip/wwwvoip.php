...
<form method="POST" action="index.php?panel=inst&menu=deletetlv&typ=komp">
<?php
...
<table style="text-align: center; width: <?php echo $conf[width2];?>; height:<?php echo $conf[height2];?>">
  <tbody>
    <tr class="tr1">
