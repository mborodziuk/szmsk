...
<a href="index.php?panel=fin&menu=addnewjzd&data_od=<?php echo $param[data_od] ?>
&data_do=<?php echo $param[data_do]?>&pojazd=<?php echo $param[pojazd]?>">Nowe jazdy </a>&nbsp;
<a href="javascript&#058;displayWindow('pdf/mkpdf.php?dok=epp&data_od=<?php echo $param[data_od] ?>
&data_do=<?php echo $param[data_do]?>&pojazd=<?php echo $param[pojazd]?>',1100,800, '38')">Ewidencja przebiegu pojazdu</a>
