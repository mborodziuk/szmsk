...
//		$this->Image("$conf[pdf_logo1]",15,10,70,15);
	...
	*/
	...
	function MakeFV(&$pdf, $dbh, $dokks, $typ, $adrk=false, $file="../func/config.php")
	{
		...
		$pdf->SetXY(111,55);
		$pdf->MultiCell(70,4,"$dokks[nazwa]",0,L,0);
		$pdf->Text(112,67,$adres1);	
		$pdf->Text(112,71,$adres2);	
...
k.nazwa, k.ulica, k.nr_bud, k.nr_mieszk, k.kod, k.miasto, kw.numer, a.uwagi, u.cecha, k.cecha, u.nazwa2
from
		...
		$dokks=array
			(
				...
				'k_nazwa' 		=> $row[15],	'k_ulica' 			=> $row[16],'k_nr_bud'		=> $row[17], 'k_nr_mieszk' => $row[18],
					...
					'cecha'			=> $row[23],	'k_cecha'				=> $row[24], 		'ulica2'				=> $row[25]
				);
