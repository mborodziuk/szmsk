						...
						<div id="userstab" class="panel panel-default tab-pane fade in active">
							...
							<table class="table table-responsive table-striped">
								<thead>
									<tr>
										<th>
											<a href="?show=devices&nodes=<?=$device_id?>&order=id&sort=<?=$sortby?>">LP</a>
										</th>
										<th>
											<a href="?show=devices&nodes=<?=$device_id?>&order=name&sort=<?=$sortby?>">Node</a>
										</th>
										<th>
											<a href="?show=devices&nodes=<?=$device_id?>&order=vlan&sort=<?=$sortby?>">VLAN</a>
										</th>
										<th>
											<a href="?show=devices&nodes=<?=$device_id?>&order=b.name&sort=<?=$sortby?>">User</a>
										</th>
										<th>
											<a href="?show=devices&nodes=<?=$device_id?>&order=street&sort=<?=$sortby?>">Street</a>
										</th>
										<th>
											<a href="?show=devices&nodes=<?=$device_id?>&order=rxPowerMin&sort=<?=$sortby?>">RxMin</a>
										</th>
										<th>
											<a href="?show=devices&nodes=<?=$device_id?>&order=rxPower&sort=<?=$sortby?>">RxPower</a>
										</th>
										<th>
											<a href="?show=devices&nodes=<?=$device_id?>&order=rxPowerMax&sort=<?=$sortby?>">RxMax</a>
										</th>
										<th>
											<a href="?show=devices&nodes=<?=$device_id?>&order=rxPowerDiff&sort=<?=$sortby?>">RxDiff</a>
										</th>
										<th>
											<a href="?show=devices&nodes=<?=$device_id?>&order=distance&sort=<?=$sortby?>">Distance</a>
										</th>
										<th>
											<a href="?show=devices&nodes=<?=$device_id?>&order=transTemperature&sort=<?=$sortby?>">Temp</a>
										</th>
										<th>
											<a href="?show=devices&nodes=<?=$device_id?>&order=transTemperatureMax&sort=<?=$sortby?>">Temp Max</a>
										</th>
										<th>
											<a href="?show=devices&nodes=<?=$device_id?>&order=Register_Time&sort=<?=$sortby?>">Reg</a>
										</th>
										<th>
											<a href="?show=devices&nodes=<?=$device_id?>&order=Deregister_Time&sort=<?=$sortby?>">DeReg</a>
										</th>
										<th>
											<a href="?show=devices&nodes=<?=$device_id?>&order=state&sort=<?=$sortby?>">State</a>
										</th>
										<th>
											<a href="?show=devices&nodes=<?=$device_id?>&order=last_update&sort=<?=$sortby?>">Update</a>
										</th>
										<th>
											<a href="?show=devices&nodes=<?=$device_id?>&order=mac&sort=<?=$sortby?>">MAC</a>
										</th>
										<th>
											<a href="?show=devices&nodes=<?=$device_id?>&order=type&sort=<?=$sortby?>">Type</a>
										</th>
									</tr>
								</thead>
								<tbody>
