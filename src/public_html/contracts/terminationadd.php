...
<form enctype="multipart/form-data"  method="POST" action="index.php?panel=fin&menu=sendterminationadd">
...
<tr>
	...
	<tr>
		...
		<td class="klasa4">
				<input size="10" name="data_wej" value =<?php echo $data_wej ?> />
		</td>	
	</tr>		
	<tr>
	<td>
