...
<form method="POST" action="index.php?panel=fin&menu=updateinstwyslij&inst=<?php echo $_GET[inst] ?>">
...
<tbody>
	<tr>
		...
		<tr>
			...
			<td class="klasa4">
				<input size="40" name="i_nazwa" value="<?php echo $inst[nazwa]?>">
			</td>
		</tr> 
		<tr>
		<td class="klasa2"> 
		...
		<td class="klasa4">
				<input size="20" name="i_symbol" value="<?php echo $inst[symbol]?>">
		</td>
	</tr> 
	<tr>
		<td class="klasa2">
		...
		<td class="klasa4">
				<input size="20" name="i_ulica" value="<?php echo $inst[ulica]?>">
		</td>	
	</tr>
	<tr>
		<td class="klasa2">
		...
		<td class="klasa4">
				<input size="2" name="i_nrbud" value="<?php echo $inst[nr_bud]?>">
		</td>	
	</tr>
	<tr>
		<td class="klasa2">
		...
		<td class="klasa4">
				<input size="2" name="i_nrmieszk" value="<?php echo $inst[nr_lokalu]?>">
		</td>
	</tr>
	<tr>
		<td class="klasa2">
		...
		<td class="klasa4">
				<input size="6" name="i_kod" value="<?php echo $inst[kod]?>">
		</td>	
	</tr>
	<tr>
				<td class="klasa2">
				...
				<td class="klasa4">
					<input size="20" name="i_miasto" value="<?php echo $inst[miasto]?>">
				</td>	
			</tr>
			<tr>
				<td class="klasa2">
				...
				<td class="klasa4">
					<input size="15" name="i_telefon" value="<?php echo $teli[telefon]?>">
				</td>
			</tr>
			<tr>
				<td class="klasa2">
				...
				<td class="klasa4">
					<input size="15" name="i_telkom"  value="<?php echo $teli[tel_kom]?>">
				</td>
			</tr>
			<tr>
				<td class="klasa2">
				...
				<td class="klasa4">
					<input size="15" name="i_email" value="<?php echo $maili[email]?>" >
				</td>
			</tr>
			<tr>
				<td class="klasa1" colspan="2" >
	...
	<tr>
		...
		<td class="klasa4">
				<input size="2" name="k_nrlokalu" value="<?php echo $kontakty[nr_mieszk]?>">
		</td>
	</tr>
	<tr>
		<td class="klasa2">
	...
	<tr>
			...
			<tr>
				...
				<td class="klasa4">
					<input size="18" name="k_email" value="<?php echo $mailk[email]?>">
				</td>
			</tr>
			<tr>
				<td colspan="2">
