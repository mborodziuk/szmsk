<?php
	$Q1="select count(*) from wplaty where data_ksiegowania like '$_POST[od_rok]-$_POST[od_miesiac]-%'";
	$Q2="select count(*) from wplaty where data_ksiegowania like '$_POST[od_rok]-$_POST[od_miesiac]-%' and forma like '$firma[wyciag2]'";
	$Q3="select count(*) from wplaty where data_ksiegowania like '$_POST[od_rok]-$_POST[od_miesiac]-%' and forma like '$firma[wyciag]'";
	$Q4="select count(*) from wplaty where data_ksiegowania like '$_POST[od_rok]-$_POST[od_miesiac]-%' and forma like 'gotówka'";
	$Q5="select count(*) from wplaty where data_ksiegowania like '$_POST[od_rok]-$_POST[od_miesiac]-%' and forma like '$firma[wyciag3]'";
	
	$Q6="select sum(kwota) from wplaty where data_ksiegowania like '$_POST[od_rok]-$_POST[od_miesiac]-%'";
	$Q7="select sum(kwota) from wplaty where data_ksiegowania like '$_POST[od_rok]-$_POST[od_miesiac]-%' and forma like '$firma[wyciag2]'";
	$Q8="select sum(kwota) from wplaty where data_ksiegowania like '$_POST[od_rok]-$_POST[od_miesiac]-%' and forma like '$firma[wyciag]'";
	$Q9="select sum(kwota) from wplaty where data_ksiegowania like '$_POST[od_rok]-$_POST[od_miesiac]-%' and forma like 'gotówka'";
	$Q10="select sum(kwota) from wplaty where data_ksiegowania like '$_POST[od_rok]-$_POST[od_miesiac]-%' and forma like '$firma[wyciag3]'";
...
<a href="index.php?panel=fin&menu=dodajwpl">Wpłata </a> &nbsp;
<a href="index.php?panel=fin&menu=wczytajwpl">Wczytaj wpłaty</a> &nbsp;
<br/>
<br/>
...
<form method="POST" action="index.php?panel=fin&menu=wplaty">
<table style="text-align: left; width: 800px; height: 50px;" class="tbk1" >
  ...
  <table style="text-align: left; width: 800px; height: 60px;" class="tbk1">
    <tbody>		
	<tr class="tr1">
      <td style="width: 90px;">
      	Id
