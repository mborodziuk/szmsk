...
<a href="index.php?panel=fin&menu=debitnoteadd">Nowa nota obciążeniowa </a> &nbsp;
...
<?php
	...
	$TABLE1="noty_obciazeniowe";
	$ID="nr_nob";

	$_SESSION[del1]=array($TABLE1=>$ID);
	$_SESSION[del2]=array();

?>
<form method="POST" action="index.php?panel=fin&menu=debitnotes">
...
<form method="POST" action="index.php?panel=fin&menu=deleteno">
