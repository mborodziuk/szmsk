<form method="POST" action="index.php?panel=fin&menu=invoiceadd2&typ=<?php echo $_GET[typ]?>">
...
<tbody>
	...
	<tr>
		...
		<td class="klasa4">
				<input size="15" name="data_sprzed" value="<?php echo $invoices->PierwszyRoboczy(date("Y-m")); ?>">
		</td>
	</tr>
	<tr>
		<td class="klasa2">
