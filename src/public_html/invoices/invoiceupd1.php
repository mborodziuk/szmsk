...
?>
<form method="POST" action="index.php?panel=fin&menu=invoiceupdsnd1&typ=<?php echo $_GET[typ]?>&nr=<?php echo $_GET[nr]?>">
...
<tbody>
	...
	<tr>
		...
		<td class="klasa4">
			<?php
				if($_GET[typ]=="sprzedaz")
					$www->SelectWlasc($dbh, "odbiorca",$dokks[id_odb]);
				else
				...
				<table class="tbk1" style="text-align: left; width: 750px; height: 75px;" border="1" cellpadding="0" cellspacing="0">
				  <tbody>
				      ...
				      <td style="width: 70px;">
						...
						<?php
							$invoices->InvoiceArticleList($dbh, $_GET[typ], $_GET[nr]);
						?>
				  </tbody>
				</table>
		</td>
	...
	<tr>
		<td>
					<br>
				 <a href="index.php?panel=fin&menu=invoiceupd2">Dodaj pozycję >>></a>
					<br>
				 <a href="index.php?panel=fin&menu=invoiceupd3">Dodaj rozmowy tel. >>></a>
			</td>
	</tr>
	<tr>
