<?php
   $Q="	select w.id_wpl, w.data_ksiegowania, w.forma, w.kwota, w.opis
	...
	('id_wpl' 	=> $_GET[wpl], 	'data_wpl'		=>$row[1], 	'forma'	=>$row[2], 	'kwota'		=>$row[3],
	'id_kontrah'		=>	$row2[0],	'opis'		=>$row[4] );
?>

<form method="POST" action="index.php?panel=fin&menu=paymentupdsnd&wpl=<?php echo $_GET[wpl] ?>">
...
<tbody>
	...
	<tr>
		...
		<td class="klasa4">
			<?php
				$www->SelectWlasc($dbh, 'abon', $wpl[id_kontrah]);
			?>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td class="klasa4">
				<input size="10" name="data_wpl" value="<?php echo $wpl[data_wpl] ?>">
		</td>	
	</tr>
	<tr>
		<td class="klasa2">
